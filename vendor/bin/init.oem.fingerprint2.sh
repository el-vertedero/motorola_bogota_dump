...
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/fpc_mtk_tee.ko" "/vendor/lib/modules/$GKI_PATH/goodix_fps_mmi_u.ko")
kernel_so_name_list=("fpc_mtk_tee.ko" "goodix_fps_mmi_u.ko")
